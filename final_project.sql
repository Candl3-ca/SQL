...
MAXVALUE 999999;
 ...
 ALTER TABLE GUIDES
 TRIP_ID CHAR(4) REFERENCES TRIP ON DELETE CASCADE; -- SO WE DONT SHOW INFORMATION ABOUT UNAVAILABLE TRIPS
 ...
 FEE NUMERIC,
 TRACKER VARCHAR(10),
 TRIP_ID CHAR(4) REFERENCES TRIP ON DELETE SET CASCADE); -- SO WE DONT SHOW INFORMATION ABOUT UNAVAILABLE TOURS
